...
移植自 TikTokDownloader (JoeanAmier/TikTokDownloader/src/encrypt/xBogus.py)。
用于移动端 API (aweme.snssdk.com) 的 URL 参数签名，与桌面端 aBogus 不同。
"""
